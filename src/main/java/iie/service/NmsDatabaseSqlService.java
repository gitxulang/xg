 ...
 */
@Service("NmsDatabaseSqlService")
public class  NmsDatabaseSqlService {
    @Autowired
    HibernateTemplate hibernateTemplate;

    public PageBean<NmsDatabaseSql> getPageByDate(String orderKey, String orderValue, String startDate, String endDate, int begin, int offset, String statusId) throws Exception {
        Session session = hibernateTemplate.getSessionFactory().openSession();

        String sqlCount = "select count(1) from nms_database_sql as ds where ds.status_id ='" + statusId + "'";
        ...
        String sqlList = "select * from nms_database_sql as ds where ds.status_id = '" + statusId + "'";
        if (startDate != null && endDate != null) {
        ...
        queryList.addEntity("NmsDatabaseSql", NmsDatabaseSql.class);
        List<NmsDatabaseSql> list = queryList.list();
        session.close();

        PageBean<NmsDatabaseSql> page = new PageBean<NmsDatabaseSql>();
    ...
    public List<NmsDatabaseSql> getPageByDateExportExcel(String orderKey, String orderValue, String startDate, String endDate, String statusId) throws Exception {
        Session session = hibernateTemplate.getSessionFactory().openSession();
