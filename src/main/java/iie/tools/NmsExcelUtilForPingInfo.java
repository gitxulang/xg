...
public class NmsExcelUtilForPingInfo {
			...
			for (int i = 0, imax = list.size(); i < imax; i++) {
				...
				//		String k = field.getName();
						...
						if (field.get(list.get(i)) == null
							...
							switch (j) {
							case 0:
								v = String.format("%.0f", Float.valueOf(field.get(list.get(i)).toString()));
								break;
							case 1:
	...
	public NmsExcelUtilForPingInfo() {
		super();
	}

	public NmsExcelUtilForPingInfo(List<?> list, Class<?> clazz,
