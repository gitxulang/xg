...
public class NmsExcelUtilForMemInfo {
			...
			for (int i = 0, imax = list.size(); i < imax; i++) {
				...
				//		String k = field.getName();
						...
						if (field.get(list.get(i)) == null
							...
							switch (j) {
							case 0:					
								double value = (Long)field.get(list.get(i))*1.0;
								value = value / 1024 / 1024;
								v = String.format("%.2f", value);
								break;
							case 1:
								value = (Long)field.get(list.get(i))*1.0;
								value = value / 1024 / 1024;
								v = String.format("%.2f", value);
								break;
							case 2:
...
/*							case 6:
	...
	public NmsExcelUtilForMemInfo() {
		super();
	}

	public NmsExcelUtilForMemInfo(List<?> list, Class<?> clazz,
