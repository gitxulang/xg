...
public class NmsExcelUtilForAlarmDetail {
				...
				for (int j = 0; j < namesOfField.size(); j++) {
					...
					//	String k = field.getName();
						...
						if (field.get(list.get(i)) == null
							...
							NmsAlarm info = (NmsAlarm) field.get(list.get(i));
							switch (j) {
							case 0:
								if(info.getALevel() == 1) {
									v = "低风险";
								} else if (info.getALevel() == 2) {
									v = "中风险";
								} else if (info.getALevel() == 3) {
									v = "高风险";
								} else {
									v = "其它";
								}
								break;
							case 1:
								NmsAsset asset = info.getNmsAsset();
								if (asset != null) {
									v = info.getNmsAsset().getAIp();
								} else {
									v = "--";
								}
								break;
...
/*							case 3:
							...
							case 4:
								...
								break;
							case 5:
								int dStatusCode = info.getDStatus();
								switch (dStatusCode) {
								case 0:
									v = "待处理";
									break;
	...
	public NmsExcelUtilForAlarmDetail() {
		super();
	}

	public NmsExcelUtilForAlarmDetail(List<?> list, Class<?> clazz,
