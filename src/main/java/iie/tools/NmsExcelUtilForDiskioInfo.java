...
public class NmsExcelUtilForDiskioInfo {
				...
				//		String k = field.getName();
						...
						if (field.get(list.get(i)) == null
							...
							case 1:
								...
								break;
							case 2:
								v = String.format("%.2f", Double.valueOf((field.get(list.get(i)).toString())));
								break;
							case 3:
								v = String.format("%.2f", Double.valueOf((field.get(list.get(i)).toString())));
								break;
	...
	public NmsExcelUtilForDiskioInfo() {
		super();
	}

	public NmsExcelUtilForDiskioInfo(List<?> list, Class<?> clazz,
