...
public class NmsExcelUtilForPerformanceRealtime {
			...
			//			String k = field.getName();
						...
						if (field.get(list.get(i)) == null
							...
							case 1:
								...
								break;
							case 2:
								String strType = (String) field
										.get(list.get(i));
								field = clazz.getDeclaredField("subChType");
								field.setAccessible(true);
								String StrSubType = (String) field.get(list
										.get(i));
								v = strType + "/" + StrSubType;
								break;
							case 3:
								v = field.get(list.get(i)).toString();
								v = new BigDecimal(Double.valueOf(v)*100).setScale(0, BigDecimal.ROUND_HALF_UP).toString();
								break;
							case 4:
								v = field.get(list.get(i)).toString();
								v = new BigDecimal(Double.valueOf(v)).setScale(2, BigDecimal.ROUND_HALF_UP).toString();
								break;
							case 5:
								v = field.get(list.get(i)).toString();
								v = new BigDecimal(Double.valueOf(v)/1024/1024).setScale(2, BigDecimal.ROUND_HALF_UP).toString();
								break;
							case 6:
								v = field.get(list.get(i)).toString();
								v = new BigDecimal(Double.valueOf(v)*100).setScale(2, BigDecimal.ROUND_HALF_UP).toString();
								break;
							case 7:
								v = field.get(list.get(i)).toString();
								v = new BigDecimal(Double.valueOf(v)/1024/1024).setScale(2, BigDecimal.ROUND_HALF_UP).toString();
	...
	public NmsExcelUtilForPerformanceRealtime() {
		super();
	}

	public NmsExcelUtilForPerformanceRealtime(List<?> list, Class<?> clazz,
