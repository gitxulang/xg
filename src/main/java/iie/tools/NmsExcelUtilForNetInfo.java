...
public class NmsExcelUtilForNetInfo {
				...
				//		String k = field.getName();
						...
						if (field.get(list.get(i)) == null
							...
							case 0:
								...
								break;
							case 1:
								int value = (Integer) field.get(list.get(i));
								if (value == 1) {
									v = "up";
								} else if (value == 2) {
									v = "down";
								...
								break;
							case 2:
								value = (Integer) field.get(list.get(i));
								if (value == 1) {
									v = "up";
								} else if (value == 2) {
									v = "down";
							...
							case 8:
								...
								break;								
							case 9:
								long value1 = (Long) field.get(list.get(i));
								v = String.valueOf(value1);
								break;
							case 10:
								value1 = (Long) field.get(list.get(i));
								v = String.valueOf(value1);
								break;
							case 11:
								value1 = (Long) field.get(list.get(i));
							...
							case 22:
								v = format.format(new Date(((Timestamp) field
										.get(list.get(i))).getTime()));
								break;
							default:
								v = "-";
								break;
	...
	public NmsExcelUtilForNetInfo() {
		super();
	}

	public NmsExcelUtilForNetInfo(List<?> list, Class<?> clazz,
