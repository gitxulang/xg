...
public class NmsExcelUtilForStaticInfo {
			...
			for (int i = 0, imax = list.size(); i < imax; i++) {
				...
				//		String k = field.getName();
						...
						if (field.get(list.get(i)) == null
							...
							switch (j) {
							case 0:
								v =  String.valueOf(field.get(list.get(i)));
								if (v == null) {
									v = "--";
								}
								break;
	...
	public NmsExcelUtilForStaticInfo() {
		super();
	}

	public NmsExcelUtilForStaticInfo(List<?> list, Class<?> clazz,
