...
public class NmsExcelUtilForTomcatInfo {
			...
			//			String k = field.getName();
						...
						if (field.get(list.get(i)) == null
							...
							case 2:
								...
								break;								
							case 3:
								long millisecond = Long.valueOf(field.get(list.get(i)).toString());
								Date date = new Date(millisecond);
								SimpleDateFormat format1 = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
								v = format1.format(date);
								break;								
							case 4:
								v = field.get(list.get(i)).toString();
								break;								
	...
	public NmsExcelUtilForTomcatInfo() {
		super();
	}

	public NmsExcelUtilForTomcatInfo(List<?> list, Class<?> clazz,
