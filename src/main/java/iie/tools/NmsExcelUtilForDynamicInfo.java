...
public class NmsExcelUtilForDynamicInfo {
		...
		if (list != null && list.size() > 0) {
			for (int i = 0, imax = list.size(); i < imax; i++) {
				...
				//		String k = field.getName();
						String v = "";
				//		System.out.println(k + ":" + field.get(list.get(i)));
						...
						if (field.get(list.get(i)) == null
							...
							switch (j) {
							case 0:
								v = format.format(field.get(list.get(i)));
								break;
							case 1:
								v = (String) field.get(list.get(i));
								break;
							case 2:
								if ((Long)field.get(list.get(i)) == 0) {
									v = "--";
								} else {
									v = format.format(field.get(list.get(i)));
								}
	...
	public NmsExcelUtilForDynamicInfo() {
		super();
	}

	public NmsExcelUtilForDynamicInfo(List<?> list, Class<?> clazz,
