...
/**
 * NmsRuleAsset entity. @author MyEclipse Persistence Tools
 */

public class NmsRuleAsset implements java.io.Serializable {
	...
	/** minimal constructor */
	public NmsRuleAsset(Integer REnable, Timestamp itime) {
		this.REnable = REnable;
		this.itime = itime;
	}

	/** full constructor */
	public NmsRuleAsset(NmsAssetType nmsAssetType, NmsAsset nmsAsset,
			Integer DType, String RName, String RContent, String RUnit,
			Integer RSeq, Integer REnable, Integer RValue1, Integer RValue2,
			Integer RValue3, Timestamp itime) {
