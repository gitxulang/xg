...
function loadReport(id) {
	$.ajax({
		...
		error: function(jqXHR, textStatus, errorThrown) {
            console.log("[ERROR] /alarm/findByAlarmId: " + textStatus);
		},
		complete: function(xhr) {
			if ("REDIRECT" == xhr.getResponseHeader("REDIRECT")) {
            	...
            	console.log("[DEBUG] /alarm/findByAlarmId: no function");
...
function submitReport() {
	...
	$.ajax({
		...
		error: function(jqXHR, textStatus, errorThrown) {
            console.log("[ERROR] /alarm/deal/report: " + textStatus);
		},
		complete: function(xhr) {
			if ("REDIRECT" == xhr.getResponseHeader("REDIRECT")) {
				var win = window;
            	...
            	console.log("[DEBUG] /alarm/deal/report: no function");
            	$("#page-inner").html(showNoFunction(100, 600));
			}
		}
	});
