...
$(document).ready(
    function () {
        $("body").append(
            ...
            + '<div class="orderDomain_count" style="display:none;">0</div>'
...
function query(dataJson) {
    ...
    $.ajax({
        ...
        data: dataJson,
        dataType: "json",
        url: "/MiddlewareInstance/list/date",
...
function loadList(json) {
    ...
    for (var i in json.list) {
        ...
        $("#tableBodyID").append(
            ...
            '<td>' + json.list[i].ip + '</td>' +
            '<td>' + json.list[i].domain + '</td>' +
...
function exportTable() {
    var url = "/MiddlewareInstance/list/date/ExportExcel?"
    var start_time = $("#start_time").val();
    var end_time = $("#end_time").val();
    var id = $("#configId").val();
