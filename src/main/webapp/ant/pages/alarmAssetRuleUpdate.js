...
function loadRule(id) {
	$.ajax({
		type: 'POST',
		dataType: "json",
		url: "/RuleAsset/findNmsRuleAssetById",
		data: {"id":id},
		...
		error: function(jqXHR, textStatus, errorThrown) {
            console.log("[ERROR] /RuleAsset/findNmsRuleAssetById: " + textStatus);
		},
		complete: function(xhr) {
			if ("REDIRECT" == xhr.getResponseHeader("REDIRECT")) {
            	...
            	console.log("[DEBUG] /RuleAsset/findNmsRuleAssetById: no function");
...
function updateRule() {
	...
	$.ajax({
		type: 'POST',
		dataType: "json",
		url: "/RuleAsset/updateNmsRuleAssetById",
		data: dataJson,
		contentType: 'application/x-www-form-urlencoded;charset=utf-8',
		timeout: 5000,
		cache: true,
		...
		error: function(jqXHR, textStatus, errorThrown) {
            console.log("[ERROR] /RuleAsset/updateNmsRuleAssetById: " + textStatus);
		},
		complete: function(xhr) {
			if ("REDIRECT" == xhr.getResponseHeader("REDIRECT")) {
				var win = window;
